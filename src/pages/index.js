...
export default () => (
  <Layout>
    ...
    <span><a href='https://www.linkedin.com/in/godfrey-wanjala-14601a73/' target='_blank' className={layout.linkedin}>linkedin</a></span> 
    <span><a href='https://github.com/willeswa' target='_blank' className={layout.github}>github</a></span> 
    <span><a href='https://twitter.com/wanjalake' target='_blank' className={layout.twitter}>twitter</a></span>
    </div>
    <div>
